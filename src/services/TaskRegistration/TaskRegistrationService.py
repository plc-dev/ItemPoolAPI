...
class TaskRegistrationService(Service):
    """
    ...
    def __init__(self):
        super().__init__()
        self._material_registration_service = TaskMaterialRegistrationService()

        self._task_handlers: dict[str, TaskHandler] = {
            TaskType.sql: SQLTaskHandler(self._dao, self._material_registration_service)
        }
